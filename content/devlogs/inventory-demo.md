...
![image](/Devlogs/InventoryDemo/1.PNG)
Here the player has picked up some items and arranged them in their inventory

![image](/Devlogs/InventoryDemo/2.PNG)
Then, the player can store these items in a chest.
